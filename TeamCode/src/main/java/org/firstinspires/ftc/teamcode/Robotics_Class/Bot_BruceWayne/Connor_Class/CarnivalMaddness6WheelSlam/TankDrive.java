package org.firstinspires.ftc.teamcode.Robotics_Class.Bot_BruceWayne.Connor_Class.CarnivalMaddness6WheelSlam;
...
import org.firstinspires.ftc.teamcode.Robotics_Class.Bot_BruceWayne.Connor_Class.CarnivalMaddness6WheelSlam.messages.DriveCommandMessage;
import org.firstinspires.ftc.teamcode.Robotics_Class.Bot_BruceWayne.Connor_Class.CarnivalMaddness6WheelSlam.messages.PoseMessage;
import org.firstinspires.ftc.teamcode.Robotics_Class.Bot_BruceWayne.Connor_Class.CarnivalMaddness6WheelSlam.messages.TankCommandMessage;
import org.firstinspires.ftc.teamcode.Robotics_Class.Bot_BruceWayne.Connor_Class.CarnivalMaddness6WheelSlam.messages.TankLocalizerInputsMessage;
...
public final class TankDrive {
    ...
    public final List<DcMotorEx> frontleftMotor, frontrightMotor, rearLeftMotor, rearRightMotor;
        ...
        public DriveLocalizer() {
            {
                ...
                for (DcMotorEx m : frontleftMotor) {
...

            {
                ...
                for (DcMotorEx m : frontrightMotor) {
                    Encoder e = new OverflowEncoder(new RawEncoder(m));
                    rightEncs.add(e);
                }
    ...
    public TankDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        frontleftMotor = Arrays.asList(hardwareMap.get(DcMotorEx.class, "front_left_motor"));
        frontrightMotor = Arrays.asList(hardwareMap.get(DcMotorEx.class, "front_right_motor"));
        rearLeftMotor = Arrays.asList(hardwareMap.get(DcMotorEx.class,"rear_left_motor"));
        rearRightMotor = Arrays.asList(hardwareMap.get(DcMotorEx.class,"rear_right_motor"));
        ...
        for (DcMotorEx m : rearRightMotor) {
            m.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
