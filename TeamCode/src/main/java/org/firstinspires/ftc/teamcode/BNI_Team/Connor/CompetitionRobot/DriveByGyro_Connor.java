...
//
//public class DriveByGyro_Connor {
...
//                rearLeftTarget = rearLeftMotor.getCurrentPosition() + moveCounts;
//                rearRightTarget = rearRightMotor.getCurrentPosition() + moveCounts;
//
//                // Set Target FIRST, then turn on RUN_TO_POSITION
//                frontLeftMotor.setTargetPosition(frontLeftTarget);
//                frontRightMotor.setTargetPosition(frontRightTarget);
//                rearLeftMotor.setTargetPosition(rearLeftTarget);
//                rearRightMotor.setTargetPosition(rearRightTarget);
//
...
//                        (frontLeftMotor.isBusy() && frontRightMotor.isBusy() && rearLeftMotor.isBusy() && rearRightMotor.isBusy())) {
//
